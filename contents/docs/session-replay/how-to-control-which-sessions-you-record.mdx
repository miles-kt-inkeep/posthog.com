...
> **Note:** Feature flags used in replay settings cannot be deleted. You must first remove the flag from the replay settings above before you can delete it. This prevents accidentally breaking your session replay configuration.
