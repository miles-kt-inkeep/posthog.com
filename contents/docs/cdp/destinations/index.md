...
PostHog enables you to send realtime data to dozens of pre-configured destinations. Check out the [Destinations](https://us.posthog.com/data-management/destinations) page under Data Management to get started.
